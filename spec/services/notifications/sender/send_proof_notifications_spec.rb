...
RSpec.describe Notifications::Sender::SendNotifications do
  ...
  describe "New Proofs" do
    ...
    it "should send a notification to problem followers when a proof is added" do
    ...
    it "should not send you a notification if you are following the problem and you create a proof as well" do
  ...
  describe "Updated Proofs" do
    ...
    it "should only send one notification to a user, even if has multiple roles (ie. creator, editor, commenter, follower)" do
