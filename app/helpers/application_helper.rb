module ApplicationHelper
  ...
  def header
    ...
    elsif ("problems" == controller_name and (action_name == "index" or action_name == "feed" or action_name == "show" or action_name == 'new' or action_name == "edit" or action_name == "log")) or (controller_name == "topics") or current_page?(root_path) or controller_name == 'help_center' or controller_name == "proofs" or controller_name == "users" or controller_name == "registrations" or controller_name == "search"
      return
